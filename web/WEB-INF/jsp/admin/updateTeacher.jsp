        ...
        <form class="layui-form" id="updateForm">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="a_username" value="${teacher.t_teacherid}" required
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="a_password" value="${teacher.t_password}" required
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="a_name" value="${teacher.t_name}" required lay-verify="required"
                           placeholder="请输入姓名"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
