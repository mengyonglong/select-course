        ...
        <div style="padding: 15px;">
            ...
            <div class="row" style="float: right">
                <div class="form-inline">
                    ...
                    <button type="button" class="btn btn-dark"
                            onclick="window.location.href='/admin/queryStudent?start=${studentList.prePage}'">上一页
                    </button>
                    ...
                    <button type="button" class="btn btn-dark"
                            onclick="window.location.href='/admin/queryStudent?start=${studentList.nextPage}'">下一页
                    </button>
                    <button type="button" class="btn btn-dark"
                            onclick="window.location.href='/admin/queryStudent?start=${studentList.navigateLastPage}'">
                        尾页
                    </button>
                </div>
            </div>
