...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="padding: 15px;">修改课程信息</div>

        <form class="layui-form" id="updateForm">
            <div class="layui-form-item">
                <label class="layui-form-label">课程号</label>
                <div class="layui-input-block">
                    <input type="text" name="c_id" value="${course.c_id}" required
                           lay-verify="required" placeholder="请输入课程号"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="c_name" value="${course.c_name}" required
                           lay-verify="required" placeholder="请输入课程名"
                           autocomplete="off" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="c_properties" value="${course.c_properties}" required lay-verify="required"
                           placeholder="请输入属性"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="c_credit" value="${course.c_credit}" required lay-verify="required"
                           placeholder="请输入学分"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="c_place" value="${course.c_place}" required lay-verify="required"
                           placeholder="请输入属性"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="t_name" value="${course.t_name}" required lay-verify="required"
                           placeholder="请输入教师名"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="formDemo" onclick="updateCourse()">立即提交
                    </button>
                </div>
            </div>
        </form>
...
<script type="text/javascript">
    function updateCourse() {
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/updateCourseOfTeacher",
            type: 'post',
            dataType: "json",
            ...
            success: function (data) {
                if (data !== "null") {
                    alert("修改成功");
                    window.location.href = "${pageContext.request.contextPath}/admin/queryCourse";
                }
            }
        })
    }
