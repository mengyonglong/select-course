...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <br>
        <a href="/admin/queryStudentCourse?start=0">首页</a>
        <a href="/admin/queryStudentCourse?start=${studentCourseList.prePage}">上一页</a>
        <c:forEach items="${studentCourseList.navigatepageNums}" var="pageNum">
            <a href="/admin/queryStudentCourse?start=${pageNum*2-2}">${pageNum}</a>
        </c:forEach>
        <input type="text" id="searchtea" placeholder="请输入您想要查询的页码">
        <button name="bts" onclick="searchTea()">查询</button>
        <a href="/admin/queryStudentCourse?start=${studentCourseList.nextPage}">下一页</a>
        <a href="/admin/queryStudentCourse?start=${studentCourseList.navigateLastPage}">尾页</a>
