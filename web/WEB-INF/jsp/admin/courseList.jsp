...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <br>
        <a href="/admin/queryCourse?start=0">首页</a>
        <a href="/admin/queryCourse?start=${courseList.prePage}">上一页</a>
        <c:forEach items="${courseList.navigatepageNums}" var="pageNum">
            <a href="/admin/queryCourse?start=${pageNum*2-2}">${pageNum}</a>
        </c:forEach>
        <input type="text" id="searchtea" placeholder="请输入您想要查询的页码">
        <button name="bts" onclick="searchTea()">查询</button>
        <a href="/admin/queryCourse?start=${courseList.nextPage}">下一页</a>
        <a href="/admin/queryCourse?start=${courseList.navigateLastPage}">尾页</a>
