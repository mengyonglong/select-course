    ...
    <div class="layui-body">
        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-4 column" style="font-weight: lighter">已选课程</div>
                <div class="col-md-4 column"></div>
                <div class="col-md-4 column">
                    <%--搜索图书--%>
                    <form class="form-inline" action="/student/searchChooseCourse" method="post"
                          style="float: right;padding-bottom: 20px;">
                        <input type="text" class="form-control" name="c_name" value="${c_name}" placeholder="请输入您所要查询课程的名称"
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <c:forEach items="${courseList.list}" var="course" varStatus="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success" id="selects${course.c_id}" value="退选"
            ...
            <div class="row" style="float: right">
                <div class="form-inline">
                    <button type="button" class="btn btn-dark"
                            onclick="window.location.href='/student/queryMyCourse?start=0'">
                        首页
                    </button>
                    <button type="button" class="btn btn-dark"
                            onclick="window.location.href='/student/queryMyCourse?start=${courseList.prePage}'">上一页
                    </button>
                    <c:forEach items="${courseList.navigatepageNums}" var="pageNum">
                        <button type="button" class="btn btn-dark"
                                onclick="window.location.href='/student/queryMyCourse?start=${pageNum*2-2}'">${pageNum}</button>
                    </c:forEach>
                    <input type="text" class="form-control" type="text" style="width: auto" id="numPage"
                           placeholder="请输入您想要查询的页码">
                    <button name="bt" type="button" class="btn btn-info" onclick="searchPage()">查询</button>
                    <button type="button" class="btn btn-dark"
                            onclick="window.location.href='/student/queryMyCourse?start=${courseList.nextPage}'">下一页
                    </button>
                    <button type="button" class="btn btn-dark"
                            onclick="window.location.href='/student/queryMyCourse?start=${courseList.navigateLastPage}'">尾页
                    </button>
                </div>
            </div>
        </div>
...
<div style="padding: 15px;">
    ...
    <div class="row" style="float: right">
        <div class="form-inline">
            <button type="button" class="btn btn-dark"
                    onclick="window.location.href='/student/searchChooseCourse?start=0&c_name=${c_name}'">
                首页
            </button>
            <button type="button" class="btn btn-dark"
                    onclick="window.location.href='/student/searchChooseCourse?start=${courseList.prePage}&c_name=${c_name}'">
                上一页
            </button>
            <c:forEach items="${courseList.navigatepageNums}" var="pageNum">
                <button type="button" class="btn btn-dark"
                        onclick="window.location.href='/student/searchChooseCourse?start=${pageNum*2-2}&c_name=${c_name}'">${pageNum}</button>
            </c:forEach>
            ...
            <button type="button" class="btn btn-dark"
                    onclick="window.location.href='/student/searchChooseCourse?start=${courseList.nextPage}&c_name=${c_name}'">
                下一页
            </button>
            <button type="button" class="btn btn-dark"
                    onclick="window.location.href='/student/searchChooseCourse?start=${courseList.navigateLastPage}&c_name=${c_name}'">
                尾页
            </button>
        </div>
    </div>
