                            ...
                            <tr>
                                ...
                                <td>
                                    <c:if test="${sessionScope.admin.a_power==1}">
                                        <c:if test="${admin.a_power==1}">
                                            <button type="button" class="btn btn-success"
                                                    onclick="window.location.href='/admin/updateOtherAdmin/${admin.a_id}'">  修改
                                            </button>
                                            <button type="button" class="btn btn-danger"
                                                    onclick="deladm(${admin.a_id})" disabled>删除
                                            </button>
                                        </c:if>
                                    ...
                                    <c:if test="${sessionScope.admin.a_power==0}">
                                        <c:if test="${admin.a_power==1}">
                                            <button type="button" class="btn btn-success"
                                                    onclick="window.location.href='/admin/updateOtherAdmin/${admin.a_id}'" disabled>
                                                修改
                                            </button>
                                            <button type="button" class="btn btn-danger"
                                                    onclick="deladm(${admin.a_id})" disabled>删除
                                        ...
                                        <c:if test="${admin.a_power==0}">
                                            <button type="button" class="btn btn-success"
                                                    onclick="window.location.href='/admin/updateOtherAdmin/${admin.a_id}'">
                                                修改
                                            </button>
                                            <button type="button" class="btn btn-danger"
                                                    onclick="deladm(${admin.a_id})">删除
        ...
        <div style="padding: 15px;">
            ...
            <div class="row" style="float: right">
                <div class="form-inline">
                    ...
                    <input class="form-control" type="text" style="width: auto" id="searchadm"
...
<div style="padding: 15px;">
    ...
    <div class="row" style="float: right">
        <div class="form-inline">
            ...
            <button type="button" class="btn btn-dark"
                    onclick="window.location.href='/admin/searchAdmin?start=${adminList.navigateLastPage}&a_name=${a_name}'">
                尾页
            </button>
        </div>
    </div>
